...
_ALPAMAYO_CONTRACT_BENCH_IN_REPO = REPO_ROOT / "tools" / "alpamayo_speed" / "bench_alpamayo_metadrive_contract.py"
_ALPAMAYO_CONTRACT_BENCH_SIBLING_LAYOUT = REPO_ROOT.parent / "openpilot_alpamayo" / "openpilot" / "tools" / "alpamayo_speed" / "bench_alpamayo_metadrive_contract.py"
ALPAMAYO_CONTRACT_BENCH = (
  _ALPAMAYO_CONTRACT_BENCH_IN_REPO
  if _ALPAMAYO_CONTRACT_BENCH_IN_REPO.exists()
  else _ALPAMAYO_CONTRACT_BENCH_SIBLING_LAYOUT
)
