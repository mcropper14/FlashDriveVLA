...
QT_MOC_LITERAL(4, 44, 14), // "scrollToToggle"
QT_MOC_LITERAL(5, 59, 11), // "updateState"
QT_MOC_LITERAL(6, 71, 7), // "UIState"
QT_MOC_LITERAL(7, 79, 1) // "s"

    },
    "TogglesPanel\0expandToggleDescription\0"
    "\0param\0scrollToToggle\0updateState\0"
    "UIState\0s"
};
#undef QT_MOC_LITERAL
...
void TogglesPanel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->scrollToToggle((*reinterpret_cast< const QString(*)>(_a[1]))); break;
