...
struct qt_meta_stringdata_TreeOptionDialog_t {
    QByteArrayData data[1];
    char stringdata0[17];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_TreeOptionDialog_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_TreeOptionDialog_t qt_meta_stringdata_TreeOptionDialog = {
    {
QT_MOC_LITERAL(0, 0, 16) // "TreeOptionDialog"
...
static const uint qt_meta_data_TreeOptionDialog[] = {
...
void TreeOptionDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
QT_INIT_METAOBJECT const QMetaObject TreeOptionDialog::staticMetaObject = { {
    &DialogBase::staticMetaObject,
    qt_meta_stringdata_TreeOptionDialog.data,
    qt_meta_data_TreeOptionDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
const QMetaObject *TreeOptionDialog::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *TreeOptionDialog::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_TreeOptionDialog.stringdata0))
        return static_cast<void*>(this);
    return DialogBase::qt_metacast(_clname);
}

int TreeOptionDialog::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = DialogBase::qt_metacall(_c, _id, _a);
    return _id;
}
